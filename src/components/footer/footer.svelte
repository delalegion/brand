<script lang="ts">
   ...
   onMount(() => {     
      ...
      // socials items
      const socialsContainer = gsap.utils.toArray(".footer-socials");
...
<footer id="footer" class="max-w-screen-2xl py-8 sm:py-12 md:py-16 lg:py-20 xl:py-24 place-content-center px-4 sm:px-8 mx-auto">
   ...
   <div class="flex items-center flex-row gap-10 pt-16 md:pt-10 footer-bottom">
      ...
      <p class="text-dark-400 text-caption font-semibold">Hubert Kruk 2024 @ Wszelkie prawa zastrzeżone | <a href="/policy-privacy">Polityka prywatności</a></p>
   </div>
</footer>